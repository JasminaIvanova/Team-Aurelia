...
namespace Aurelia.App.Areas.Identity.Pages.Account.Manage
{
    public class TwoFactorAuthenticationModel : PageModel
    {
        ...
        public TwoFactorAuthenticationModel(
            UserManager<AureliaUser> userManager, SignInManager<AureliaUser> signInManager, ILogger<TwoFactorAuthenticationModel> logger, ApplicationDbContext aureliaDB)
        {
